				...
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<h5 class="card-title text-capitalize mb-0">
							...
							<a v-if="producto.tipo==1" class="text-decoration-none text-dark" :href="'/tours/' + pedidos[index].url" target="_parent">{{producto.nombre}}</a></strong>

							<a v-if="producto.tipo==2" class="text-decoration-none text-dark" :href="'/tours/' + pedidos[index].url" target="_parent">{{producto.nombre}}</a></strong>
