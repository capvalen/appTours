...
//echo "buscar ".$aBuscar . " indice ". $ciudades[$indice]['nombre'];
?>
...
.bandera {width: 20px;}
	...
	<div class="container">
			...
			<?php if(isset($_GET['id'])):?> <span>Paquetes y tours de: <?= $departamentos[$_GET['id']-1];?> </span><?php endif;?>
    			...
    			<?php if($indice<>-1):?> <span>Tours y paquetes de <?= $ciudades[$indice]['nombre']; ?> </span><?php else: $texto=''; echo "Resultados de la ciudad: ".$txtSimple; endif;?>
