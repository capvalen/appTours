...
try {
		...
		$mail->Host       = 'peru-travel.pe';                     //Set the SMTP server to send through
		...
		//Recipients
		$mail->setFrom('facturas@peru-travel.pe', "Perú Travel");
					...
					<tr>
						...
						<td align="center">
							<div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:20px 20px; font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
								<div style="text-align:center;"><img src="https://peru-travel.pe/app/facturador/images/empresa.jpg" style="width: 150px;"></div>
								<h1 style="text-align:center;">Perú Travel S.A.C.<h1>
								<div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding:0px 20px;font-weight: 400;text-align:left;">
									...
									<div style="padding:25px 0px;text-align:center">
										<a href="https://peru-travel.pe/app/render/calificar.php?id='.$_POST['id'].'" target="_blank" style="line-height: 16px;color: #ffffff;font-weight: 400;text-decoration: none;font-size: 12px;display: inline-block;padding: 8px 15px;background-color: #ffc135; color: #702400; border-radius: 5px;	min-width: 80px;">Calificar Servicio</a>
									</div>
									<div>
